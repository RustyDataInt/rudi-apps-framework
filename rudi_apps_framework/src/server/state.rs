...
pub struct ServerState {
    suite_name:    Signal<String>,
    app_name:      Signal<Option<String>>,
    step_name:     Signal<Option<String>>,
    step_states:   Signal<HashMap<String, String>>,
    step_outcomes: Signal<HashMap<String, String>>,
}
impl ServerState {
    ...
    pub fn new(suite_name: &str) -> Self {
        ServerState {
            suite_name:    Signal::new(suite_name.to_string()),
            app_name:      Signal::new(None),
            step_name:     Signal::new(None),
            step_states:   Signal::new(HashMap::new()),
            step_outcomes: Signal::new(HashMap::new()),
        }
    }
